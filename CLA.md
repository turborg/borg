...
Thank you for your interest in contributing to **borg** (the "Project"),
stewarded by **xshellz** ("we" or "us"), the organization that supports the
turborg open-source project and holds the project's trademarks. This
Contributor License Agreement ("CLA") describes the terms under which you
("You") contribute to the Project.

By posting the comment

> I have read the CLA Document and I hereby sign the CLA

on a Pull Request to the borg repository, You accept and agree to the
following terms for Your present and future Contributions submitted to the
Project. You may not submit a Contribution unless You sign this CLA.
...
- **"Submit"** means any form of electronic, verbal, or written communication
  sent to us, including but not limited to communication on issue trackers,
  pull requests, and code review systems, but excluding communication
  conspicuously marked by You as "Not a Contribution."

## 2. Grant of Copyright License

You hereby grant to us, and to recipients of software distributed by us, a
perpetual, worldwide, non-exclusive, no-charge, royalty-free, irrevocable
copyright license to reproduce, prepare derivative works of, publicly display,
publicly perform, sublicense, and distribute Your Contributions and such
derivative works **under any license terms we choose**, including but not
limited to the Apache License 2.0 under which the Project is currently
distributed.

This grant explicitly permits us to relicense the Project (including Your
Contributions) under different terms in the future, in whole or in part.
...
2. Each of Your Contributions is Your original creation, or You have
   sufficient rights to Submit it under the terms of this CLA.
...
This CLA is loosely based on the [Apache Software Foundation Individual
Contributor License Agreement v2.2](https://www.apache.org/licenses/icla.pdf)
and is signed via the [contributor-assistant](https://github.com/contributor-assistant/github-action)
GitHub Action on each Pull Request.
